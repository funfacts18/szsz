...
const sectionIds = ['top', 'news', 'policy', 'security', 'fraud', 'ai', 'contact', 'downloads', 'ecosystem']
...
createApp({
  ...
  mounted() {
    ...
    let ecosystemSection = document.querySelector('#ecosystem')
    if (!ecosystemSection) {
      ecosystemSection = document.createElement('section')
      ecosystemSection.id = 'ecosystem'
      ecosystemSection.className = 'section hidden ecosystem-section'
      ecosystemSection.innerHTML = `<div class="page-hero ecosystem-hero"><div class="shell"><span class="micro">09 / APPLICATION ECOSYSTEM</span><h2 class="page-title">应用生态</h2><p>连接学习、科研、校园服务与数据实践，发现适合你的数字化工具。</p></div></div><div class="shell ecosystem-directory"><section class="ecosystem-intro"><div><small>CONNECT · CREATE · GROW</small><h3>一个入口，发现你的<br>数字应用生态</h3><p>把常用工具、学习资源和校园服务放在一起，按场景找到可靠、易用、可持续的数字能力。</p></div><div class="ecosystem-stats"><div><strong>04</strong><span>应用方向</span></div><div><strong>12+</strong><span>精选入口</span></div><div><strong>01</strong><span>校园平台</span></div></div></section><section class="ecosystem-block"><div class="ecosystem-section-title"><span>01</span><div><small>APPLICATION HUB</small><h3>常用应用入口</h3><p>按你正在做的事情，选择一个合适的数字工具。</p></div></div><div class="ecosystem-card-grid"><button type="button" class="ecosystem-card"><span class="ecosystem-card-icon">AI</span><span class="ecosystem-card-index">01</span><strong>AI 工具与智能体</strong><p>从提示词设计、内容核验到智能体实践，建立可信的 AI 工作流。</p><span class="ecosystem-card-tags">提示词　智能体　内容核验</span><b>查看入口 <i>→</i></b></button><button type="button" class="ecosystem-card"><span class="ecosystem-card-icon">学</span><span class="ecosystem-card-index">02</span><strong>学习与科研</strong><p>汇集课程学习、资料检索和科研协作所需的数字资源。</p><span class="ecosystem-card-tags">课程　检索　协作</span><b>查看入口 <i>→</i></b></button><button type="button" class="ecosystem-card"><span class="ecosystem-card-icon">校</span><span class="ecosystem-card-index">03</span><strong>校园服务</strong><p>常用校园平台、办公服务与远程访问入口，一站式快速找到。</p><span class="ecosystem-card-tags">办事　邮箱　远程访问</span><b>查看入口 <i>→</i></b></button><button type="button" class="ecosystem-card"><span class="ecosystem-card-icon">数</span><span class="ecosystem-card-index">04</span><strong>数据实践</strong><p>从数据素养、数据安全到数据要素应用，边学边做完成实践。</p><span class="ecosystem-card-tags">数据　安全　实践</span><b>查看入口 <i>→</i></b></button></div></section><section class="ecosystem-block ecosystem-scenes"><div class="ecosystem-section-title"><span>02</span><div><small>SCENE NAVIGATION</small><h3>按场景开始</h3><p>先明确目标，再组合你需要的工具与资源。</p></div></div><div class="ecosystem-scene-grid"><article><span>学习成长</span><p>提升检索、表达、协作与数字素养。</p><div><em>数字学习</em><em>AI 辅助</em><em>安全自测</em></div></article><article><span>教学科研</span><p>支持课程建设、科研管理与数据协作。</p><div><em>科研工具</em><em>数据实践</em><em>资源共享</em></div></article><article><span>校园生活</span><p>快速连接校园服务，处理日常数字事务。</p><div><em>服务大厅</em><em>学校邮箱</em><em>远程访问</em></div></article></div></section><section class="ecosystem-cta"><div><small>YOUR DIGITAL WORKFLOW</small><h3>从一个应用开始，建立自己的数字工作流</h3><p>应用生态正在持续完善，更多校园工具与实践资源将陆续上线。</p></div><span>更多入口<br>即将上线</span></section></div>`
