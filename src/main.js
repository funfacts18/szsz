...
createApp({
  ...
  mounted() {
    ...
    if (footer && !document.querySelector('.source-bar')) footer.insertAdjacentHTML('beforebegin', '<div class="source-bar"><div class="shell"><span>参考来源：</span><a href="https://www.nda.gov.cn/sjj/index_pc.html" target="_blank" rel="noopener">国家数据局 ↗</a><a href="http://www.npc.gov.cn/npc/" target="_blank" rel="noopener">中国人大网 ↗</a><a href="https://www.caict.ac.cn/?from=dy.199908.top" target="_blank" rel="noopener">中国信息通信研究院 ↗</a><a href="https://www.cac.gov.cn/index.htm" target="_blank" rel="noopener">中央网络安全和信息化委员会办公室 ↗</a></div></div>')
