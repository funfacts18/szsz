...
createApp({
  ...
  mounted() {
    ...
    if (!ecosystemSection) {
      ...
      ecosystemSection.innerHTML = `<div class="page-hero ecosystem-hero"><div class="shell"><span class="micro">09 / APPLICATION ECOSYSTEM</span><h2 class="page-title">应用生态</h2><p>连接学习、科研、校园服务与数据实践，发现适合你的数字化工具。</p></div></div><div class="shell ecosystem-directory"><section class="ecosystem-scene-grid ecosystem-scene-direct" aria-label="应用生态场景"><article><span>学习成长</span><p>提升检索、表达、协作与数字素养。</p><div><em>数字学习</em><em>AI 辅助</em><em>安全自测</em></div></article><article><span>教学科研</span><p>支持课程建设、科研管理与数据协作。</p><div><em>科研工具</em><em>数据实践</em><em>资源共享</em></div></article><article><span>校园生活</span><p>快速连接校园服务，处理日常数字事务。</p><div><em>服务大厅</em><em>学校邮箱</em><em>远程访问</em></div></article></section><section class="ecosystem-data-flow"><div class="ecosystem-lower-title"><span>03</span><div><small>DATA LIFECYCLE</small><h3>数据全流程</h3><p>以清晰的流程理解数据如何产生价值，并在每一步保持可控与可追溯。</p></div></div><div class="ecosystem-flow-steps"><article><b>01</b><strong>数据来源</strong><p>明确数据从哪里来、由谁产生。</p></article><i aria-hidden="true">→</i><article><b>02</b><strong>业务处理</strong><p>按业务目标进行整理、分析与加工。</p></article><i aria-hidden="true">→</i><article><b>03</b><strong>授权使用</strong><p>在明确范围和权限内合规使用。</p></article><i aria-hidden="true">→</i><article><b>04</b><strong>安全归档</strong><p>完成留存、备份、追踪与到期处置。</p></article></div></section><section class="ecosystem-support"><div class="ecosystem-support-square" aria-hidden="true"><span>DATA<br>CARE</span></div><div class="ecosystem-support-panel"><small>NEED A HAND?</small><h3>把每一次数据使用，都变成可确认的行动</h3><nav aria-label="应用生态帮助入口"><button type="button"><strong>使用指南</strong><span>快速了解平台功能与使用步骤</span><b>→</b></button><button type="button"><strong>常见问题</strong><span>查看账号、数据和应用使用中的常见疑问</span><b>→</b></button><button type="button"><strong>提交问题</strong><span>反馈使用过程中遇到的问题与建议</span><b>→</b></button></nav></div></section><section class="ecosystem-cta"><div><small>YOUR DIGITAL WORKFLOW</small><h3>从一个应用开始，建立自己的数字工作流</h3><p>应用生态正在持续完善，更多校园工具与实践资源将陆续上线。</p></div><span>更多入口<br>即将上线</span></section></div>`
